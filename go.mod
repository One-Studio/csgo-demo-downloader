...
require (
	github.com/One-Studio/ptools v0.1.9
...
// replace github.com/wailsapp/wails/v2 v2.0.0-beta.38 => /Users/purp1e/go/pkg/mod/github.com/wailsapp/wails/v2@v2.0.0-beta.38
